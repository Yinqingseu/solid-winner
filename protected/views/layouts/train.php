...
<head>
    ...
    <script type="text/javascript" src="<?php echo TRAIN_JS;?>dvwaPage.js"></script>
        ...
        <div class="navbar">
            <ul class="nav">
                <li><a href="<?php echo SITE_URL;?>/index.php?r=user/layout" style="color:#ffffff;">首页</a></li>>
                 <li class="dropdown"><a href="<?php echo SITE_URL;?>/index.php?r=train/index" class="dropdown-toggle" style="color:#ffffff;" >训练内容<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo SITE_URL;?>/index.php?r=train/model&id=1">渗透测试训练</a></li>
                        <li><a href="<?php echo SITE_URL;?>/index.php?r=train/model&id=2">靶场训练</a></li>
                        <li><a href="<?php echo SITE_URL;?>/index.php?r=train/model&id=3">攻防训练</a></li>
                        <li><a href="<?php echo SITE_URL;?>/index.php?r=train/mediaconfig">攻防实例</a></li>
                    </ul>
                </li>
                <li><a href="#" style="color:#ffffff;">历史训练</a></li>
