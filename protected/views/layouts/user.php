...
<body>
    <ul id="board">
            <li><a href="<?php echo SITE_URL?>/index.php?r=user/infoedit">欢迎您：<?php  echo Yii::app()->user->name;?></a>用户ID：<?php echo Yii::app()->user->id; ?></li>   
    ...
    <div id="menu">
        <div class="navbar">
            <ul class="nav">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" style="color:#ffffff;" >作业<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">查看作业</a></li>
                        <li><a href="#">查看成绩</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a href="#" class="dropdown-toggle" style="color:#ffffff;" >个人管理<b class="caret"></b></a>
                    <ul class="dropdown-menu"><!--查看自己各个模块的学习进度，参照信管网的用户管理-->
                        <li><a href="#">学习进度</a></li>
                        <li><a href="#">作业</a></li>
                        <li><a href="<?php echo SITE_URL;?>/index.php?r=user/infoedit">个人信息编辑</a></li>
                    </ul>
                </li>
