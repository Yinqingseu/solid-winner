    ...
    <div id="menu">
        <div class="navbar">
            <ul class="nav">
                ...
                <li><a href="<?php echo SITE_URL;?>/index.php?r=scan/hole"  style="color:#ffffff;" >漏洞信息</a></li>
                <li><a href="<?php echo SITE_URL;?>/index.php?r=scan/holeup" style="color:#ffffff;">漏洞提交</a></li>
                <li><a href="http://www.cnnvd.org.cn/vulnerability/statistics" target="_blank" style="color:#ffffff;">查询统计</a></li>
            </ul>
        </div>
    </div>
    <div class="clear"></div> 
