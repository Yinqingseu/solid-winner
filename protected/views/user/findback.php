...
<head>
    ...
    <title>网络攻防实验平台身份认证</title>
        ...
        <script type="text/javascript"
                src="<?php echo JS_URL;?>jquery.min.js"></script>
        <script type="text/javascript"
...
<body class="body_bg" >
    <h2><span>激活用户可以通过以下方式找回密码</span>
        <a  href="<?php echo SITE_URL;?>/index.php?r=user/login" title="返回"><span style="float: right;font-size: 20px;color: #c75900;">返回</span></a>
    </h2>
