...
<html lang="en">
<head>
    <title>网络攻防实验学生操作平台</title>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta name="author" content="YQ"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="网络攻防实验学生操作平台" />
...
<body>
	...
	<div id="menu">
            <div class="navbar">
                <ul class="nav">
                    <li><a href="<?php echo SITE_URL;?>/index.php?r=user/login" style="color:#ffffff;">退出注册</a></li>
                </ul>
            </div>
	</div>
            ...
            <div id="mainContent">                    
                <div id="newsShow">
                    ...
                    <?php $form = $this -> beginWidget('CActiveForm',
                            ...
                            <table border="0" cellpadding="5" cellspacing="3" style="text-align:left; width:50%;">
                                <tbody>
                                    <tr>
                                        <td align="center"> 
                                    ...
                                    <tr>
                                          <td align="center"> 
                                           <?php echo $form -> labelEx($user_model,'user_number');?>
                                        </td>
                                        <td>
                                            <?php echo $form->textField($user_model,'user_number',array('class'=>'inputBg','id'=>'User_user_number')); ?> 
                                              <?php echo $form -> error($user_model,'user_number'); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                          <td align="center"> 
                                    ...
                                    <tr>
                                         ...
                                         <td align="center"> 
                                            <?php echo $form -> label($user_model,'user_qq');?>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <?php echo $form ->dropDownList($user_model,'user_sex',$sex,array('separator'=>'&nbsp;')); ?>               
                                        </td>
                                    </tr>
