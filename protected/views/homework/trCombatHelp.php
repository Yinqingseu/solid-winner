    <div id="wrap">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo SITE_URL;?>/index.php?r=targetRangeCombat/index">首页</a></li>
            <li><a href="<?php echo SITE_URL;?>/index.php?r=targetRangeCombat/combat">靶场实战</a></li>
            <li><a href="<?php echo SITE_URL;?>/index.php?r=targetRangeCombat/rulesConfig">靶场配置</a></li>            
            ...
            <div id="mainContent">
                <!--<div id="rightContent">-->
                    <div id="newsShow">
                        ...
                        <p align="center">
                            <a href="<?php echo SITE_URL;?>/index.php?r=homework/trCombatConfig" class="btn btn-default" role="button">返回</a>                 
                        </p>
                    </div>
                <!--</div>-->
                <div class="clear"></div>
