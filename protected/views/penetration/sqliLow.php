...
<div id="main_menu">
        <div id="main_menu_padded">
            <ul class="menuBlocks">
                <li onclick="window.location='<?php echo SITE_URL;?>/index.php?r=penetration/index&trainId=<?php echo $v->train_id?>&trainModel=<?php echo $v->train_model?>'" >
...
<div id="main_body">				
    ...
    <div class="vulnerable_code_area">
            <form action="#" method="GET">
                    ...
                    <input type='hidden' name='user_token' value='b83182f2dbaa318fee9bfaf3f249a17b' />
            </form>
...
<div id="system_info">
        <input type="button" value="查看帮助" class="popup_button" onClick="javascript:popUp( '#' )"> 
