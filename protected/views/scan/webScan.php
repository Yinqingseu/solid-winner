    ...
    <div id="mainContainer">
        <div id="mainContent">
            <div id="newsShow">
                ...
                <div id="div2">
                    <p> <!-- 扫描ID号-->
                        <?php echo $form->label($webConfig,'scan_id'); ?><strong>:</strong>&nbsp;&nbsp;
                        <?php echo $form->textField($webConfig,'scan_id',array('id'=>'scan_id','style'=>'color:blue;border:0px;background-color:transparent;')); ?>
                    <!-- 扫描模式-->
                        <br /><?php echo $form->label($webConfig,'model'); ?><strong>:</strong>&nbsp;&nbsp;
                        <?php echo $form->textField($webConfig,'model',array('id'=>'model','style'=>'color:blue;border:0px;background-color:transparent;')); ?>
                   <!-- 扫描用户-->
                         <br /><?php echo $form->label($webConfig,'creator'); ?><strong>:</strong>&nbsp;&nbsp;
                        <?php echo $form->textField($webConfig,'creator',array('id'=>'creator','style'=>'color:blue;border:0px;background-color:transparent;')); ?>
                    <!-- 扫描命名-->   
                         <br /><?php echo $form->label($webConfig,'scan_name'); ?><strong>:</strong>&nbsp;&nbsp;&nbsp;&nbsp;
                         <?php echo $form->textField($webConfig,'scan_name'); ?>&nbsp;&nbsp;
                         <font color="red"><?php echo $form ->error($webConfig,'scan_name'); ?></font>
                         
                        <!-- 扫描url设置-->
                        <?php echo $form->label($webConfig,'scan_url'); ?><strong>:</strong>&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php echo $form->urlField($webConfig,'scan_url'); ?>&nbsp;&nbsp;
                        <font color="red"> <?php echo $form -> error($webConfig,'scan_url'); ?> </font><br />
                     <!-- 扫描工具选择--> 
                         <?php echo $form->label($webConfig,'choice'); ?><strong>:</strong>&nbsp;&nbsp;
                        <?php echo $form->radioButtonList($webConfig,'choice',$choice,array('separator'=>'&nbsp;&nbsp;','onclick'=>'show()')); ?>
                    </p>
                    <div id="hidden1" style="display: none;">
                        <p><!--扫描网站漏洞种类-->
                            <?php echo $form->label($webConfig,'scan_holelist'); ?><strong>:</strong>&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $form->checkBoxList($webConfig,'scan_holelist',$hole,array('separator'=>'&nbsp;&nbsp;')); ?>&nbsp;&nbsp;
                            <font color="red"><?php echo Yii::app()->user->getFlash('holelist_error');  ?></font>
                            <br /><font color="blue">(目前可扫描检测出的漏洞种类有：SQL注入漏洞，XSS漏洞。)</font>
                        </p>
                        <p><!-- 扫描深度设置-->
                            <?php echo $form->label($webConfig,'scan_depth'); ?><strong>:</strong>&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $form-> dropDownList($webConfig,'scan_depth',$depth); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                        <!-- 扫描线程数设置-->
                            <?php echo $form->label($webConfig,'numofthreads'); ?><strong>:</strong>&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $form->dropDownList($webConfig,'numofthreads',$threads); ?>
                        </p>
                        <p align="center">
                    ...
                    <div id="hidden2" style="display: none;">
                         <p>
                            <?php echo $form->label($webConfig,'tool'); ?><strong>:</strong>&nbsp;&nbsp;
                            <?php echo $form->radioButtonList($webConfig,'tool',$tool,array('separator'=>'&nbsp;&nbsp;')); ?>&nbsp;&nbsp;
                             <font color="red"><?php echo Yii::app()->user->getFlash('tool_error');?></font>
                            <br /><b>扫描工具功能简介:</b>
                    ...
                    <div id="hidden3" style="display: none;">
                         <p>
                             <?php echo $form->label($webConfig,'selfcheck'); ?><strong>:</strong>&nbsp;&nbsp;
                            <?php echo $form->checkBoxList($webConfig,'selfcheck',$selfcheck,array('id'=>'selfcheck','separator'=>'&nbsp;&nbsp;')); ?>&nbsp;&nbsp;
                             <font color="red"><?php echo Yii::app()->user->getFlash('selfcheck_error');?></font>
                         </p> 
                         <p align="center">
                             <input  value="开始扫描" style="width: 100px;height: 40px;"class="btn btn-default" role="button" type="submit" /></p>
                    </div>
                    ...
                    <h3>扫描工具功能简介： </h2>
                            <p>
                                ...
                                <br />目前可扫描检测出的漏洞种类有：<font color="blue">SQL注入漏洞，XSS漏洞</font>。
                                <br /><font color="red">第三方漏洞扫描工具扫描工具包括以下两种:</font>
