                ...
                <div id="sidebar" class="left">
                    ...
                    <div>
                        <div id="newsTitle" class="operationcrumb">
                            <ul>
                                <li><a href="<?php echo SITE_URL;?>/index.php?r=virtualDevice/generate" style="color:red;">虚拟设备生成</a></li>
                                <li><a href="<?php echo SITE_URL;?>/index.php?r=virtualDevice/netConfig">虚拟设备网络配置</a></li>
                            </ul>  
                        </div>
                    </div>                                      
                </div>
