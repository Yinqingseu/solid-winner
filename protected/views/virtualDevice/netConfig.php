        ...
        <div id="mainContent">
            <div id="leftContent">
                <div id="sidebar" class="left">
                    <div id="newsTitle" class="breadcrumb">
                        <h3>虚拟设备</h3><!--<i class="icon-th-large"></i>-->
                    </div>
                    <div>
                        <div id="newsTitle" class="operationcrumb">
                            <ul>
                                <li><a href="<?php echo SITE_URL;?>/index.php?r=virtualDevice/generate" >虚拟设备生成</a></li>
                                <li><a href="<?php echo SITE_URL;?>/index.php?r=virtualDevice/netConfig" style="color:red;">虚拟设备网络配置</a></li>
                            </ul>  
                        </div>
                    </div>                                      
                </div>
            ...
            <div id="rightContent">
                <div id="newsShow">
                    ...
                    <p>
                        <a href="<?php echo SITE_URL;?>/index.php?r=virtualDevice/layout" class="btn btn-default" role="button">完成</a>                                         
                    </p>
                </div>
            </div>
            <div class="clear"></div>
