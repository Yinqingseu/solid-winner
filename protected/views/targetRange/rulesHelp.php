                ...
                <!--<div id="rightContent">-->
                    <div id="newsShow">
                        ...
                        <div id="newsContent">
                            <!--靶场配置介绍-->
                            <div>
                                <div id="ConfigInfo" align="center" style="margin-left: 30pt;margin-right: 30pt;text-align: left" >
                                    <table class="table table-bordered" border="" width="100%" style='vertical-align: middle;text-align: center;'>
                        ...
                        <p align="center">
                            <input name="Change" id ="changeBt" value="关闭窗口" class="btn btn-default" type="button" onclick="closeJudge()">                        
                        </p>
                    </div>
                <!--</div>-->
                <div class="clear"></div>
