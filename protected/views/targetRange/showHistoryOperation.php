                ...
                <div id="sidebar" class="left">
                    ...
                    <div>
                        <div id="newsTitle" class="operationcrumb">
                            <ul>
                                <li style="color:#337ab7;">靶场基本配置</li>
                                <li style="color:#337ab7;">靶场操作</li>
                                <li style="color:red;">靶场结果</li>
                            </ul>
                        </div>
                    </div>                                     
                </div>
                    ...
                    <div class="clear"></div>                                                                                                         
                        <table class="table table-bordered" border="1" width="100%">
                            ...
                            <tbody style="font-weight: bold;" align="center">
                                ...
                                <tr>
                                    <td>2016-12-08 9:00--10:05</td> 
                                    <td>嗅探端口</td>
                                    <td>成功嗅探XXX端口</td>
                                </tr>                                
                                <tr>
                                    <td>2016-12-08 12:00--13:05</td> 
                                    <td>包里破解数据库SQL SERVER的sa用户密码</td>
                                    <td>尝试失败</td>
                                </tr>                               
                            </tbody>
                        </table>                       
                    <p align="center">
                            <a href="<?php echo SITE_URL;?>/index.php?r=targetRange/generateDownload" class="btn btn-default" role="button">下载</a>
                            <a href="<?php echo SITE_URL;?>/index.php?r=targetRange/resultAll" class="btn btn-default" role="button">返回</a>                                                        
                    </p>                    
                </div>                
            </div>
        </div>
