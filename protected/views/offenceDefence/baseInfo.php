                        ...
                        <table class="table table-bordered" border="1" width="100%">
                            ...
                            <tr>
                                <td colspan="6" align="center">
                                    ...
                                    <a href="<?php echo SITE_URL;?>/index.php?r=offenceDefence/operation" class="btn btn-default" role="button">开始操作</a>    <!--跳转到开始操作的第一步，介绍操作-->                        
                                </td>
                            </tr>                                  
                            </tbody>
                        </table>
...
<script type="text/javascript">
    function firm(){
        ...
        if(confirm("确定返回进行修改？")){
            var addr ='<?php echo SITE_URL;?>/index.php?r=offenceDefence/roleModelConfig';//跳转地址，根据用户的选择出现不同的界面？
