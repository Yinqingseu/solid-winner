...
<head>
    ...
    <meta content="width=device-width,initial-scale=0.8, minimum-scale=0.8, maximum-scale=3"
          name="viewport"/>
    <meta name="description" content="网络攻防实验平台教师登录界面" />
            ...
            <div class="auth_tab_content">
                <div tabid="01" class="auth_tab_content_item" style="display: block;">
                      <?php $form = $this -> beginWidget('CActiveForm');?>
                        ...
                        <a  href="<?php echo SITE_URL;?>/index.php?r=teacher/teacher/findback" class="auth_login_forgetp">
                            <small>忘记密码？</small> 
                        </a>
                        <a href="<?php echo SITE_URL;?>/index.php?r=teacher/teacher/register" class="auth_login_forgetp">
                            <small>注册</small> 
                        </a>
