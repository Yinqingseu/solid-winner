...
<head>
    ...
    <meta content="width=device-width,initial-scale=0.8, minimum-scale=0.8, maximum-scale=3"
          name="viewport"/>
    <meta name="description" content="网络攻防实验平台管理员登录界面" />
            ...
            <div class="auth_tab_content">
                <div tabid="01" class="auth_tab_content_item" style="display: block;">
                      <?php $form = $this -> beginWidget('CActiveForm');?>
                        <p>
                            <?php echo $form->labelEx($user_login,'username') ?><!--原有网页中<input>中的内容通过array()数组进行返回-->
                            <?php echo $form->textField($user_login,'username',array('class'=>'auth_input'));?>
                            <?php echo $form->error($user_login,'username');?>
                        </p>

                        <p>
                            <?php echo $form->labelEx($user_login,'password') ?>
                            <?php echo $form->passwordField($user_login,'password',array('class'=>'auth_input'));?>
                        ...
                        <a  href="<?php echo SITE_URL;?>/index.php?r=backstage/admin/findback" class="auth_login_forgetp">
                            <small>忘记密码？</small> 
                        </a>
                        <a href="<?php echo SITE_URL;?>/index.php?r=backstage/admin/register" class="auth_login_forgetp">
                            <small>注册</small> 
                        </a>
