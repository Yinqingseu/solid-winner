            ...
            <div id="leftContent">
                <div id="sidebar" class="left">
                    <div id="newsTitle" class="breadcrumb">
                        <h3>攻防监视</h3><!--<i class="icon-th-large"></i>-->
                    </div>
                    <div>
                        <div id="newsTitle" class="operationcrumb">
                            <ul>
                                <li><a href="#">用户操作情况</a></li>
                                <li><a href="#">设备运行情况</a></li>
                                <li><a href="#">攻击防守情况</a></li>
                            </ul>  
                        </div>
                    </div>                                      
                </div>
            ...
            <div id="rightContent">
                <div id="newsShow">
                    ...
                    <div id="newsContent">
                        ...
                        <h3><a href="#">暂停用户操作</a></h3>
                        <h3><a href="#">设备重新启动</a></h3>
                        <h3><a href="#">攻防情况</a></h3>
                        <h3><a href="#">靶场情况</a></h3>
                    </div>
                </div>
