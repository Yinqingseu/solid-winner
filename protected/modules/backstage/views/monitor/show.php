        ...
        <div id="mainContent">                      
                <div id="newsShow">
                    ...
                    <div style="float:left;border:1px;width:100%">
                            <p align="center" class="MsoNormal" style="margin: 0cm 0cm 10pt; text-align: center">                                                                                                                
                                <img src="<?php echo IMG_URL;?>immediate<?php
                            if($type == 1){
                                echo "OD";
                            }
                            else if($type == 2){
                            ...
                            ?>Picture.jpg" height="300" width="480" border="10px"> 
                            </p>
                    </div>
                    <p align="center">
                            <a href="<?php echo SITE_URL;?>/index.php?r=backstage/monitor/operation" class="btn btn-default" role="button">操作</a>                            
                            <a href="<?php echo SITE_URL;?>/index.php?r=backstage/monitor/<?php echo $url;?>" class="btn btn-default" role="button">返回</a>                            
                    </p>
                </div>
            <div class="clear"></div>
        </div>
